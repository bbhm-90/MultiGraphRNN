...
root_folder_graph_calc = './results/ANN_graphs_bulk_plasticity/'
...
target_ids  = get_row_ids(data_df_raw, 53, 57)
...
out_predic = complete_prediction(NN_graphs, in_data, num_mc_trials=3, window_size=window_size,
