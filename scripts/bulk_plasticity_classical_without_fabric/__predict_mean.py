...
NN_graphs = [
                ...
                {'name':'1', 'in':["eps11", "eps22","eps33", "poro", "init_p"], 'out':["sig11", "sig22", "sig33", "sig12", "sig23", "sig13"]},
            ]
...
for key, val in out_predic.items():
    ...
    plt.legend(loc="best")
    root_folder = './results/figures_bulk_plasticity_classical_without_fabric/ave_{}_to_{}/'.format(init_set_id, end_set_id)
